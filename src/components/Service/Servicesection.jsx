...
export default function SkinHairSection() {
  ...
  return (
    <Box sx={{ p: 4 }}>
      ...
      <Tabs
        value={tab}
        onChange={(e, newValue) => { setTab(newValue); setSelectedIndex(0); }}
        centered
      ...
      <Box sx={{ display: "flex", gap: 4, flexDirection: { xs: "column", md: "row" } }}>
        ...
        <Paper
          elevation={3}
          sx={{ width: { xs: "100%", md: "30%" }, borderRadius: 3, p: 2, background: "linear-gradient(180deg, #000000, #222222)", color: "#D4AF37" }}
          data-aos="fade-up"
        >
          <Typography variant="h6" sx={{ mb: 2, fontWeight: "bold", textAlign: "center", color: "#D4AF37" }}>
          ...
          <List>
            {treatments.map((t, index) => (
              <ListItemButton
                ...
                sx={{ borderRadius: 2, mb: 1, color: "#D4AF37", "&.Mui-selected": { bgcolor: "#111", color: "#fff" } }}
                // data-aos="fade-up"
        ...
        {/* Right Content */}
        <Paper elevation={3} sx={{ flex: 1, p: 3, borderRadius: 3, display: "flex", flexDirection: "column", gap: 2 }} data-aos="fade-down">
          <Typography variant="h5" sx={{ fontWeight: "bold" }}>{selectedTreatment.title}</Typography>
          <Typography variant="body1" sx={{ mb: 2 }}>{selectedTreatment.description}</Typography>
          <Box
            component="img"
